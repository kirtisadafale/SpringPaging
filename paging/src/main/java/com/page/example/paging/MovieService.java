...
public class MovieService {
    ...
    public Movie processIncomingMovie(Movie incoming) {
        ...
        if (existing.isPresent()) {
            ...
            MovieAudit audit = new MovieAudit(exist.getId(), exist.getName(), exist.getGenre(), "SKIPPED", Instant.now());
        ...
        MovieAudit audit = new MovieAudit(saved.getId(), saved.getName(), saved.getGenre(), "CREATED", Instant.now());
        movieAuditRepo.save(audit);
